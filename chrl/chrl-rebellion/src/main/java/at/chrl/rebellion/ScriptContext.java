...
public interface ScriptContext {
	 ...
	 * After compilation static methods marked with {@link at.chrl.rebellion.metadata.OnClassLoad} are invoked
	 */
	public void init();

	/**
	 * Notifies all script classes that they must save their data and release resources to prevent memory leaks. It's done
	 * via static methods with {@link at.chrl.rebellion.metadata.OnClassUnload} annotation
	 */
	 ...
	 * </pre>
	 *
	 * @see at.chrl.rebellion.classlistener.AggregatedClassListener
	 * @see at.chrl.rebellion.classlistener.ScheduledTaskClassListener
	 *
