...
import static at.chrl.database.DatabaseFactory.getDatabaseMajorVersion;
import static at.chrl.database.DatabaseFactory.getDatabaseMinorVersion;
import static at.chrl.database.DatabaseFactory.getDatabaseName;
...
public class DAOManager {
	...
	/**
	 * This script manager is responsible for loading {@link at.chrl.database.dao.DAO} implementations
	 */
	 ...
	 * {@link at.chrl.database.dao.DAO#getClassName()} <br>
	 * If another DAO was registed - {@link at.chrl.database.dao.DAOAlreadyRegisteredException} will be thrown
	 * 
	 * @param daoClass
	 *          DAO implementation
