...
public final class HibernateService implements AutoCloseable{
	 ...
	 * @return
	 * 		true if connection was correctly initialized
	 * 
	 * @throws IllegalArgumentException if parameter is null
	 * @throws HibernateException if Session Factory could not be created (if parameter is instance of {@link HibernateConfig})
	 * @throws PersistenceException if Entity Manager could not be created (if parameter is instance of {@link JPAConfig})
	 * 
	 ...
	 * 		configuration with connection properties
	 * @return
	 * 		true if factory was properly closed
	 * 		<br>
	 ...
	 * @return
	 * 		false if this configuration has no cached connection, or reload was not successful
	 * 		<br>
	 * 		true otherwise
	 * 
	 * @throws IllegalArgumentException if parameter is null
	 * @throws HibernateException if Session Factory could not be created
	 * @throws PersistenceException if Entity Manager could not be created
	 * 
	...
	/**
	 * Returns a Session Factory Cached by this Service
	 * <br>
	 ...
	 * @return
	 * 		Cached Session Factory or null
	 * 
	 * @throws IllegalArgumentException if parameter is null
	 */
	...
	/**
	 * Returns a Entity Manager Factory Cached by this Service
	 * <br>
	 * Returns like specified in {@link ConcurrentHashMap#get(Object)}
	 * 
	 * @param config
	 * 		configuration to look for
	 * @return
	 * 		Cached Manager Factory or null
	 * 
	 * @throws IllegalArgumentException if parameter is null
	 */
	...
	/**
	 * Returns a new open and valid {@link Session}. Calls {@link HibernateService#connect(IHibernateConfig)} if needed.
	 * 
	 * @param config
	 * 			configuration
	 * @return
	 * 			a new open Hibernate Session
	 * 
	 * @throws IllegalArgumentException if parameter is null
	 * @throws HibernateException if Session Factory could not be created (if parameter is instance of {@link HibernateConfig}) - {@link HibernateService#connect(IHibernateConfig)}
	 * @throws PersistenceException if Entity Manager could not be created (if parameter is instance of {@link JPAConfig}) - {@link HibernateService#connect(IHibernateConfig)}
	 * @throws NullPointerException if no {@link SessionFactory} could be obtained, when {@link HibernateService#connect(IHibernateConfig)} was called
	 * @throws NullPointerException if config is no instance of {@link HibernateConfig} or {@link JPAConfig}
	 * 
	 * @see {@link HibernateService#connect(IHibernateConfig)}
	 * @see {@link HibernateService#disconnect(IHibernateConfig)}
	 */
	...
	/**
	 * Returns a new open and valid {@link StatelessSession}. Calls {@link HibernateService#connect(IHibernateConfig)} if needed.
	 * 
	 * @param config
	 * 			configuration
	 * @return
	 * 			a new open Hibernate Stateless Session
	 * 
	 * @throws IllegalArgumentException if parameter is null
	 * @throws HibernateException if Session Factory could not be created (if parameter is instance of {@link HibernateConfig}) - {@link HibernateService#connect(IHibernateConfig)}
	 * @throws PersistenceException if Entity Manager could not be created (if parameter is instance of {@link JPAConfig}) - {@link HibernateService#connect(IHibernateConfig)}
	...
	/**
	 * Returns a new {@link EntityManager}. Calls {@link HibernateService#connect(IHibernateConfig)} if needed.
	 * 
	 * @param config
	 * 			configuration
	 * @return
	 ...
	 * 
	 * @throws IllegalArgumentException if parameter is null
	 * @throws PersistenceException if Entity Manager could not be created - {@link HibernateService#connect(IHibernateConfig)}
	 * @throws NullPointerException if no {@link SessionFactory} could be obtained, when {@link HibernateService#connect(IHibernateConfig)} was called
	 * 
	 * @see {@link HibernateService#connect(IHibernateConfig)}
	 * @see {@link HibernateService#disconnect(IHibernateConfig)}
	...
	/**
	 * Creates Schema of given Config in given File. Also prints output to console.
	 * 
	 * @param config
	 ...
	 * 
	 * @throws HibernateException of config is no {@link HibernateConfig}
	 * 
	 */
	...
	/**
	 * Returns statistics for every database connections.
	 * <br>
	...
	/**
	 * Calls {@link #persistList(List, HibernateConfig)} concurrently.
	 * <br>
	 * Creates {@link HibernateConfig#C3P0_MAX_SIZE} * laodFactor Threads. 
	 * <br>
	 ...
	 * 
	 * @throws IllegalArgumentException if loadFactor 0s > 1d || <= 0d
	 * @throws Exception as specified in {@link #persistList(List, HibernateConfig)}
	 * 
	 * @param list
	 ...
	 * 			0 equals 1 used session.
	 * 			Use {@link #persistList(List, HibernateConfig)} in this case.
	 */
	...
	/**
	 * Calls {@link Session#saveOrUpdate(Object)} on every object in given list.
	 * <br>
	 * if a exception occurs, given object wont be persisted.
	 * <br>
	 * calls {@link #getSession(IHibernateConfig)}
	 * <br>
	 ...
	 * 
	 * @throws Exception as specified in {@link #getSession(IHibernateConfig)}
	 * @throws Exception as specified in {@link Session#saveOrUpdate(Object)}
	 * @throws Exception as specified in {@link Session#flush(Object)}
	 * @throws Exception as specified in {@link Session#close(Object)}
	 * @throws Exception as specified in {@link Session#getTransaction()}
	 * @throws Exception as specified in {@link Transaction#begin()}
	 * @throws Exception as specified in {@link Transaction#rollback()}
	 * 
	 * @param list
	 * 			object list to persist
	 * @param conf
