...
/**
 * 
 * Configuration Class for Hibernate(JPA) Database Connections. <br>
...
public abstract class JPAConfig extends HibernateConfig {
	...
	@Property(key = AvailableSettings.PROVIDER,
	...
	@Property(key = AvailableSettings.JDBC_DRIVER,
			defaultValue = "org.h2.Driver")
	public String JDBC_DRIVER;
	@Property(key = AvailableSettings.JDBC_URL,
			defaultValue = "jdbc:h2:mem:db1;DB_CLOSE_DELAY=-1;MVCC=TRUE")
	...
	@Property(key = AvailableSettings.SHARED_CACHE_RETRIEVE_MODE,
			defaultValue = "")
	public String SHARED_CACHE_RETRIEVE_MODE;
	@Property(key = AvailableSettings.SHARED_CACHE_STORE_MODE,
			defaultValue = "")
	...
	@Property(key = AvailableSettings.PERSIST_VALIDATION_GROUP,
			defaultValue = "")
	public String PERSIST_VALIDATION_GROUP;
	@Property(key = AvailableSettings.UPDATE_VALIDATION_GROUP,
			defaultValue = "")
	public String UPDATE_VALIDATION_GROUP;
	@Property(key = AvailableSettings.REMOVE_VALIDATION_GROUP,
			defaultValue = "")
	...
	@Property(key = AvailableSettings.SCHEMA_GEN_CREATE_SOURCE,
			defaultValue = "")
	...
	@Property(key = AvailableSettings.SCHEMA_GEN_CREATE_SCRIPT_SOURCE,
			defaultValue = "")
	public String SCHEMA_GEN_CREATE_SCRIPT_SOURCE;
	@Property(key = AvailableSettings.SCHEMA_GEN_DROP_SCRIPT_SOURCE,
			defaultValue = "")
	public String SCHEMA_GEN_DROP_SCRIPT_SOURCE;
	@Property(key = AvailableSettings.SCHEMA_GEN_DATABASE_ACTION,
			defaultValue = "")
	public String SCHEMA_GEN_DATABASE_ACTION;
	@Property(key = AvailableSettings.SCHEMA_GEN_SCRIPTS_ACTION,
			defaultValue = "")
	public String SCHEMA_GEN_SCRIPTS_ACTION;
	@Property(key = AvailableSettings.SCHEMA_GEN_SCRIPTS_CREATE_TARGET,
			defaultValue = "")
	public String SCHEMA_GEN_SCRIPTS_CREATE_TARGET;
	@Property(key = AvailableSettings.SCHEMA_GEN_SCRIPTS_DROP_TARGET,
			defaultValue = "")
	public String SCHEMA_GEN_SCRIPTS_DROP_TARGET;
	@Property(key = AvailableSettings.SCHEMA_GEN_CREATE_SCHEMAS,
			defaultValue = "")
	...
	@Property(key = AvailableSettings.SCHEMA_GEN_DB_MAJOR_VERSION,
			defaultValue = "")
	public String SCHEMA_GEN_DB_MAJOR_VERSION;
	@Property(key = AvailableSettings.SCHEMA_GEN_DB_MINOR_VERSION,
			defaultValue = "")
	public String SCHEMA_GEN_DB_MINOR_VERSION;
	@Property(key = AvailableSettings.SCHEMA_GEN_LOAD_SCRIPT_SOURCE,
			defaultValue = "")
	public String SCHEMA_GEN_LOAD_SCRIPT_SOURCE;
	@Property(key = AvailableSettings.ALIAS_SPECIFIC_LOCK_MODE,
			defaultValue = "")
	...
	@Property(key = AvailableSettings.COLLECTION_CACHE_PREFIX,
			defaultValue = "")
	...
	@Property(key = AvailableSettings.SESSION_FACTORY_OBSERVER,
			defaultValue = "")
	...
	@Property(key = AvailableSettings.ENTITY_MANAGER_FACTORY_NAME,
			defaultValue = "")
	public String ENTITY_MANAGER_FACTORY_NAME;
	@Property(key = AvailableSettings.JPA_METAMODEL_POPULATION,
			defaultValue = "")
	...
	@Property(key = AvailableSettings.PERSISTENCE_UNIT_NAME,
