...
import at.chrl.orm.hibernate.configuration.templates.PostgreSQLConfig;
 ...
 *
 */
public class PostgreSQLTestConfig extends PostgreSQLConfig {
	
	@Override
	public void overrideConfig(){
		super.overrideConfig();
		this.JDBC_URL = "jdbc:postgresql://localhost:5432/test";
		this.JDBC_USER = "root";
		this.JDBC_PASSWORD = "toor";
		this.HBM2DDL_AUTO = "create";
		this.PERSISTENCE_UNIT_NAME = "postgresql";
	}
