...
import at.chrl.orm.hibernate.configuration.templates.MySQLConfig;
 ...
 *
 */
public class MySQLTestConfig extends MySQLConfig {

	@Override
	public void overrideConfig(){
		super.overrideConfig();
		this.JDBC_URL = "jdbc:mysql://localhost:3306/test";
		this.JDBC_USER = "root";
		this.JDBC_PASSWORD = "toor";
		this.HBM2DDL_AUTO = "create";
		this.PERSISTENCE_UNIT_NAME = "mysql";
	}
