/**
 * (C) ChRL 2014 - chrl-utils - at.chrl.nutils - ConfigurationTest.java
 * Created: 19.07.2014 - 18:44:54
 */
...
public class ConfigUtilTest {
	...
	public static class ExampleConfig{
		...
		@Property(key = "test.math", defaultValue = "java.lang.Math::sqrt", types = {Double.class})
		public static Function<Double,?> MATH;

		@Property(key = "test.math2", defaultValue = "java.lang.Math::max", types = {Double.class, Double.class})
		...
		@Property(key = "test.args", defaultValue = "clean compile package install -U -T 3C -DskipTests")
		 ...
		 * Login Server port
		 */
		@Property(key = "loginserver.client.port", defaultValue = "2106", description="Login port of login server"
				+ "...blalalbairwetgh"
				+ "pauwegfuqwpgewbe"
				+ "puwpügq3bgob329ßtasga"
				+ "h9rehwehweh"
				+ "erherherhwerh"
				+ "werhwerhqwvjkqehrgrweh"
				+ "erhwerljghörlwehwerh"
				+ "erehrwttjtzjurzku")
		 ...
		 */
		@Property(key = "loginserver.client.logintrybeforeban", defaultValue = "5")
		public static int             LOGIN_TRY_BEFORE_BAN;

		/**
		 * Ban time in minutes
		 */
		@Property(key = "loginserver.client.bantimeforbruteforcing", defaultValue = "15")
