...
/**
 * 
 * @author Vinzynth 26.02.2015 - 22:47:01
 *
 */
public final class HibernateStatisticService {
	...
	public static String[] getSessionStatistics(final Session session) {
		...
		return new String[] { "+ Session Statistics: " + session.toString(), "+", "+ Entity Count: " + stats.getEntityCount(), "+ Collection Count: " + stats.getCollectionCount(), "+", "+" };
	}
	...
	public static String[] getSessionFactoryStatistics(final SessionFactory sessionFactory) {
		...
		return new String[] { "+ General Statistics:", "+", "+ Running Time: " + (System.currentTimeMillis() - stats.getStartTime()) / 1_000 + "s", "+", "+ Sessions Opened: " + stats.getSessionOpenCount(), "+ Sessions Closed: " + stats.getSessionCloseCount(), "+", "+ Successful Transactions: " + stats.getSuccessfulTransactionCount(), "+ Completed Transactions: " + stats.getTransactionCount(), "+", "+ Connection Requests: " + stats.getConnectCount(), "+ Flush Count: " + stats.getFlushCount(), "+", "+ Executed Queries: " + stats.getQueryExecutionCount(), "+ Slowest Query Execution Time: " + stats.getQueryExecutionMaxTime() + "ms", "+ Slowest Query: " + stats.getQueryExecutionMaxTimeQueryString(), "+", "+ Prepared Statements Acquired: " + stats.getPrepareStatementCount(), "+ Prepared Statements Released: " + stats.getCloseStatementCount(), "+ StaleObjectStateExceptions: " + stats.getOptimisticFailureCount(), "+", "+ N. Id Queries Executed: " + stats.getNaturalIdQueryExecutionCount(), "+ N. Id Query Max Exec. Time: " + stats.getNaturalIdQueryExecutionMaxTime() + "ms", "+ N. Id Query Max Exec. Time Region: " + stats.getNaturalIdQueryExecutionMaxTimeRegion(), "+", "+ Entities:", "+", "+ Entity Deletes: " + stats.getEntityDeleteCount(), "+ Entity Inserts: " + stats.getEntityInsertCount(), "+ Entity Loads: " + stats.getEntityLoadCount(), "+ Entity Fetchs: " + stats.getEntityFetchCount(), "+ Entity Updates: " + stats.getEntityUpdateCount(), "+", "+ Collections:", "+", "+ Collections Loaded: " + stats.getCollectionLoadCount(), "+ Collections Fetched: " + stats.getCollectionFetchCount(), "+ Collections Updated: " + stats.getCollectionUpdateCount(), "+ Collections Removed: " + stats.getCollectionRemoveCount(), "+ Collections Recreated: " + stats.getCollectionRecreateCount(), "+", "+", "+ Caches:", "+", "+ Query Cache Put Count: " + stats.getQueryCachePutCount(), "+ Query Cache Hit Count: " + stats.getQueryCacheHitCount(), "+ Query Cache Miss Count: " + stats.getQueryCacheMissCount(), "+ Query Cache Hit Ratio: " + ((double) stats.getQueryCacheHitCount()) / (stats.getQueryCacheHitCount() + stats.getQueryCacheMissCount()), "+", "+ N. Id Cache Put Count: " + stats.getNaturalIdCachePutCount(), "+ N. Id Cache Hit Count: " + stats.getNaturalIdCacheHitCount(), "+ N. Id Cache Miss Count: " + stats.getNaturalIdCacheMissCount(), "+ N. Id Cache Hit Ratio: " + ((double) stats.getNaturalIdCacheHitCount()) / (stats.getNaturalIdCacheHitCount() + stats.getNaturalIdCacheMissCount()), "+", "+ Timestamp Cache Put Count: " + stats.getUpdateTimestampsCachePutCount(), "+ Timestamp Cache Hit Count: " + stats.getUpdateTimestampsCacheHitCount(), "+ Timestamp Cache Miss Count: " + stats.getUpdateTimestampsCacheMissCount(), "+ Timestamp Cache Hit Ratio: " + ((double) stats.getUpdateTimestampsCacheHitCount()) / (stats.getUpdateTimestampsCacheHitCount() + stats.getUpdateTimestampsCacheMissCount()), "+", "+ 2nd Level Cache Put Count: " + stats.getSecondLevelCachePutCount(), "+ 2nd Level Cache Hit Count: " + stats.getSecondLevelCacheHitCount(), "+ 2nd Level Cache Miss Count: " + stats.getSecondLevelCacheMissCount(), "+ 2nd Level Cache Hit Ratio: " + ((double) stats.getSecondLevelCacheHitCount()) / (stats.getSecondLevelCacheHitCount() + stats.getSecondLevelCacheMissCount()), "+", "+", "+" };
	}
}
